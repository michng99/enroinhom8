...
public class Dataaa extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String addbaihat = " CREATE TABLE addBAIHAT ( hinhanh1 text , tenbaihat1 text ," +
                " file1 text , tentacgia1 text , luotnghe1 int , theloai1 text ) ";
        sqLiteDatabase.execSQL(addbaihat);
